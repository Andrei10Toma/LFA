...
class Star(Expr):
    ...
    def __str__(self) -> str:
        return 'STAR:' + self._expr.__str__()
...
class Concat(Expr):
    ...
    def __str__(self) -> str:
        return 'CONCAT:' + self._expr1.__str__() + ':' + self._expr2.__str__()
...
class Union(Expr):
    ...
    def __str__(self) -> str:
        return 'UNION:' + self._expr1.__str__() + ':' + self._expr2.__str__()
...
class Plus(Expr):
    ...
    def __str__(self) -> str:
        return  'PLUS:' + self._expr.__str__()
